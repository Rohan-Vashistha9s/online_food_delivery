  ...
  return (
    <>
      {city && name ? (
          ...
          <div className="text-left mt-10">
            ...
            {feeDetails?.message && (
              <div className="flex justify-start items-center gap-2 text-color-8 mt-3 mb-5">
                <img src={`https://food-delivery-cors.vercel.app/api/proxy/swiggy/dapi/restaurants/list/v5?lat=12.9715987&lng=77.5945627&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`} alt="icon" />
        ...
        <p className="text-color-8 text-xs font-ProximaNovaThin">Restaurant information is not available.</p>
      )}
    </>
  );
};
